...
- [local-sdk-execution.md](../shared/references/dispatcher-foundation/local-sdk-execution.md) – shipped local SDK launcher contract for local cloud-runtime reproduction
