...
- [`local-sdk-execution.md`](./shared/references/dispatcher-foundation/local-sdk-execution.md) explains the shipped local Dispatcher SDK launchers, hot-reload flow, and runtime environment variables used for cloud-side local verification.
